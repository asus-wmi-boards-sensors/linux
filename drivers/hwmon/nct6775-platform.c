...
static const struct dmi_system_id asus_wmi_info_table[] = {
	...
	DMI_MATCH_ASUS_WMI_BOARD("B150 PRO GAMING", &acpi_board_GPEM_MUTEX),
	DMI_MATCH_ASUS_WMI_BOARD("B150 PRO GAMING D3", &acpi_board_GPEM_MUTEX),
	DMI_MATCH_ASUS_WMI_BOARD("B150M PRO GAMING", &acpi_board_GPEM_MUTEX),
	...
	DMI_MATCH_ASUS_WMI_BOARD("Z170 PRO GAMING", &acpi_board_GPEM_MUTEX),
	DMI_MATCH_ASUS_WMI_BOARD("Z170 PRO GAMING/AURA", &acpi_board_GPEM_MUTEX),
